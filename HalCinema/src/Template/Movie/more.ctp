	...
	<div class="wrapper">
		...
		<div class="detail-box01">
			<div class="detail-boxA">
				<?php echo $this->Html->image('movie/sumb/'.$movie->imagePath); ?>
				<!-- <img src="images/image01.jpg" alt="映画タイトル" class="detail-img"> -->
				<p class="detail-title"><?php echo $movie->title; ?></p>
			</div>
			<div class="detail-boxB">
				<p class="detail-text"><?php echo nl2br($movie->content); ?></p>
			</div>
		</div>
		...
		<div class="detail-theaterList">
			...
			<ul class="address-theater">
				<li><p class="pre">青森県<br>
					...
					<li class="hide">
						<p class="pre">神奈川県<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ神奈川店</a>
						</p>
						<p class="pre">千葉県<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ千葉店</a>
						</p>
						<p class="pre">東京都<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ東京店</a>
						</p>
					</li>

					<li class="hide">
						<p class="pre">愛知県<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ愛知店</a>
						</p>
						<p class="pre">長野県<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ長野店</a>
						</p>
					</li>

					<li class="hide">
						<p class="pre">大阪府<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ大阪店</a>
						</p>
						<p class="pre">京都府<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ京都店</a>
						</p>
					</li>

					<li class="hide">
						<p class="pre">岡山県<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ岡山店</a>
						</p>
					</li>

					<li class="hide">
						<p class="pre">香川県<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ香川店</a>
						</p>
					</li>

					<li class="hide">
						<p class="pre">福岡県<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ福岡店</a>
						</p>
						<p class="pre">沖縄県<br>
							<a href="#detail-theater-date">&nbsp;&nbsp;HALシネマズ沖縄店</a>
						</p>
					</li>
				</ul>
